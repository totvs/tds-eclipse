...
public class RefreshConsoleLog2Minutes extends ServerMonitorHandler {
	...
	public final Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		job = new RefreshServerConsoleLogJob("Refresh 2 minutes", 120000); //$NON-NLS-1$
		job.schedule();
		isEnabled = false;
		return null;
	}
	...
	private void sendNotification() {
		...
		INotification notification = notificationService.createNotification(
				INotification.EventType.CONSOLE_REFRESH_2_MIN, this);
