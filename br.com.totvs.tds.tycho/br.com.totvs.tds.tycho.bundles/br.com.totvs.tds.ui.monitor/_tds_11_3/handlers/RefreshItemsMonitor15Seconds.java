...
public class RefreshItemsMonitor15Seconds extends ServerMonitorHandler {
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		job = new RefreshServerViewJob("Refresh 15 Seconds", 15000); //$NON-NLS-1$
		job.schedule();
		isEnabled = false;
		return null;
	}
	...
	private void sendNotification() {
		...
		INotification notification = notificationService.createNotification(
				INotification.EventType.MONITOR_REFRESH_15_SEC, this);
