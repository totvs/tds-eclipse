...
/**
 * Interface m�nima para definição de um item utilizado no
 * ServerManagerFactory.<br>
 *
 * @author acandido
 */
public interface IItemInfo extends Externalizable {
	 ...
	 *
	 * @see
	 * br.com.totvs.tds.server.internal.ModelObject#addPropertyChangeListener(java.
	 ...
	 *
	 * @see
	 * br.com.totvs.tds.server.internal.ModelObject#removePropertyChangeListener(
	 ...
	 *
	 * @throws RuntimeException emitido em caso de erro na validação.
	 */
	 ...
	 * Ajusta o nome.
	 *
	 * @param name nome �nico do elemento.
	 */
	 ...
	 *
	 * @param in Objeto de armazenamento.
	 * @throws IOException            Indica erro de I/O.
	 * @throws ClassNotFoundException Indica que não foi poss�vel localizar a
	 *                                classe.
	 */
	 ...
	 *
	 * @param out Objeto de armazenamento.
	 * @throws IOException Indica erro de I/O.
	 */
