...
public interface IServerManager {
	 ...
	 * 
	 * @param class1
	 *            Classe alvo que representa o servidor desejado.
	 * 
	 * @return lista de servidores conectados
	 */
	List<IServerInfo> getActiveServers(Class<? extends IServerInfo> class1);
	...
	/**
	 * Adiciona o validadosçõesalterações de propriedades nos servidores abaixo do grupo
	 * 
	 * @param group
	 */
	 ...
	 * 
	 * @param inputStream
	 *            , stream com os dados para leitura.
	 * @throws IOException
	 *             , erro de I/O.
	 ...
	 * 
	 * @param name
	 *            , nome do servidor a ser avaliado.
	 * @param address
	 *            , endereço URI a ser avaliado.
	 * @throws RuntimeException
	 *             , indica que falahga na validação. 
