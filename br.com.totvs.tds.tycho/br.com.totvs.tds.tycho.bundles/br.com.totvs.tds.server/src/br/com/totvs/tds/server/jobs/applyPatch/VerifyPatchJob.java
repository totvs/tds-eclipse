 ...
 */
public class VerifyPatchJob extends Job {

	public VerifyPatchJob(final String name) {
		super(name);
		this.applyPatchAttributes = new ApplyPatchAttributes();
	}
	 ...
	 */
//	public ValidatePatchJob(final String name, final ApplyPatchAttributes applyPatchAttributes) {
//		super(name);
////
