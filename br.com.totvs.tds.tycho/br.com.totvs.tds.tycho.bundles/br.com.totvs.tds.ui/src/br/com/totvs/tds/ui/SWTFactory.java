...
public class SWTFactory {
	...
	/**
	 * Creates a vertical spacer for separating components. If applied to a <code>GridLayout</code>, this method will
	 * automatically span all of the columns of the parent to make vertical space.
	 * 
	 * @param parent
	 ...
	 *            the style for how this composite should fill into its parent
	 * @param marginwidth
	 *            the width of the margin to place on the sides of the composite (default is 5, specified by GridLayout)
	 * @param marginheight
	 ...
	 * @since 3.2
	 */
	public static void showPreferencePage(final Shell shell, String id) {
		PreferencesUtil.createPreferenceDialogOn(shell, id, new String[] { id }, null).open();
	}

	/**
	 * This method allows users to open a specific preference page and supply a custom set of page filter items.
	 * 
	 * This alternative to <code>showPreferencePage(String)</code> allows other related pref pages to be shown at the
	 * same time at the developers/context discretion. All pages can be shown if <code>null</code> is passed.
	 * 
	 * @param page_id
	 ...
	 * @since 3.6
	 */
	public static void showPreferencePage(final Shell shell, String page_id, String[] page_filters) {
		PreferencesUtil.createPreferenceDialogOn(shell, page_id, page_filters, null).open();
	}
}
