...
public class ImportServerDecoratingLabelProvider extends LabelProvider implements
	...
	public Image getImage(final Object obj) {
		...
		if (!resources.containsKey(item.getClass())) {
			ImageDescriptor imageDescriptor = ServerUIActivator.getDefault().getImageDescriptor(String.format("icons/%s.png", item.getClass().getSimpleName())); //$NON-NLS-1$
			resources.put(item.getClass(), imageDescriptor.createImage());
		}		
